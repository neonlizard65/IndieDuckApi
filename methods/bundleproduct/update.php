...
// подключаем файл для работы с БД и объектом bundleproduct 
...
$bundleproduct->BundleProductID = $data->BundleProductID;

if(isset($bundleproduct->BundleProductID)){
    // устанавливаем значения свойств  

    $bundleproduct->ProductId = $data->ProductId;
    $bundleproduct->BundleId = $data->BundleId;

	// обновление товара
	if ($bundleproduct->update()) {
