...
// подключаем файл для работы с БД и объектом cartproduct 
...
$cartproduct->CartProductID = $data->CartProductID;

if(isset($cartproduct->CartProductID)){
    // устанавливаем значения свойств  

    $cartproduct->ProductId = $data->ProductId;
    $cartproduct->UserId = $data->UserId;
