...
// подключаем файл для работы с БД и объектом postmedia 
...
$postmedia->PostMediaID = $data->PostMediaID;

if(isset($postmedia->PostMediaID)){
    // устанавливаем значения свойств  

    $postmedia->PostId = $data->PostId;
    $postmedia->MediaContent = $data->MediaContent;
