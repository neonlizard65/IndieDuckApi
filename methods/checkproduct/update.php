...
// подключаем файл для работы с БД и объектом checkproduct 
...
$checkproduct->CheckProductID = $data->CheckProductID;

if(isset($checkproduct->CheckProductID)){
    // устанавливаем значения свойств  

    $checkproduct->ProductId = $data->ProductId;
    $checkproduct->CheckId = $data->CheckId;

	// обновление товара
	if ($checkproduct->update()) {
