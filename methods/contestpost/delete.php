...
// подключим файл для соединения с базой и объектом contestpost 
...
$contestpost->ContestPostID = $data->ContestPostID;
if(!empty($contestpost->ContestPostID)){
// удаление товара 
    if ($contestpost->delete()) {
