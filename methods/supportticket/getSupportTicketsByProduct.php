...
// чтение 
$supportticket->ProductId = isset($_GET["ProductId"]) ? $_GET["ProductId"] : die(); 

$stmt = $supportticket->getSupportTicketsByProduct();
...
if($rowcount > 0){
    ...
    echo json_encode(array("supportticket" => "Группы не найдены."), JSON_UNESCAPED_UNICODE);
}
?>