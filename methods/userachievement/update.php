...
// подключаем файл для работы с БД и объектом userachievement 
...
$userachievement->UserAchievementID = $data->UserAchievementID;

if(isset($userachievement->UserAchievementID)){
    // устанавливаем значения свойств  

    $userachievement->AchievementId = $data->AchievementId;
    $userachievement->UserId = $data->UserId;
    $userachievement->Date = $data->Date;
