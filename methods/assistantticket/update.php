...
// подключаем файл для работы с БД и объектом assistantticket 
...
if(isset($assistantticket->AssistantTicketID)){
    // устанавливаем значения свойств  
    $assistantticket->AssistantId = $data->AssistantId;
    $assistantticket->TicketId = $data->TicketId;

	// обновление товара
	if ($assistantticket->update()) {
