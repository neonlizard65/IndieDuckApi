...
// чтение 
$assistantticket->TicketId = isset($_GET["TicketId"]) ? $_GET["TicketId"] : die(); 

$stmt = $assistantticket->getAllAssistantsByTickets();
...
if($rowcount > 0){
    ...
    echo json_encode($assistantticket_arr["assistanttickets"]);
}
else {
