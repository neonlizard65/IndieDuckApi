...
// подключаем файл для работы с БД и объектом franchise 
...
$franchise->FranchiseID = $data->FranchiseID;

if(isset($franchise->FranchiseID)){
    // устанавливаем значения свойств  

    $franchise->FranchiseName = $data->FranchiseName;
    $franchise->FranchiseImage = $data->FranchiseImage;
