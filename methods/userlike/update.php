...
// подключаем файл для работы с БД и объектом userlike 
...
$userlike->UserLikeID = $data->UserLikeID;

if(isset($userlike->UserLikeID)){
    // устанавливаем значения свойств  

    $userlike->UserId = $data->UserId;
    $userlike->PostId = $data->PostId;
    $userlike->CommentId = $data->CommentId;
    $userlike->ContestGameId = $data->ContestGameId;
    $userlike->LikeDislike = $data->LikeDislike;
